...
namespace Playmaykr.Utils.Extensions
{
    public static class TransformExtensions
    {
        ...
        /// </summary>
        /// <param name="parent">The Transform whose child GameObjects are to be destroyed.</param>
        ...
        /// <summary>
        /// Immediately destroys all child GameObjects of the given transform.
        /// </summary>
        /// <param name="parent">The Transform whose child GameObjects are to be immediately destroyed.</param>
        ...
        /// <summary>
        /// Enables all child GameObjects of the given transform.
        /// </summary>
        /// <param name="parent">The Transform whose child GameObjects are to be enabled.</param>
        ...
        /// <summary>
        /// Disables all child GameObjects of the given transform.
        /// </summary>
        /// <param name="parent">The Transform whose child GameObjects are to be disabled.</param>
